...
def update_rover(Rover, data):
      ...
      'samples collected:', Rover.samples_collected, 'rock angles', Rover.rock_angles, 'rock distance', Rover.rock_angles, 'Samples positions',Rover.samples_pos)
...
def create_output_images(Rover):
      ...
      cv2.putText(map_add,"  Collected: "+str(Rover.samples_collected), (0, 85),
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(Rover.vision_image,"What?" + str(Rover.sample_pos_found), (0,10),
	              cv2.FONT_HERSHEY_COMPLEX, 0.4, (255,255,255), 1)
